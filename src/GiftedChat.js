...
class GiftedChat extends React.Component {
    constructor(props) {
        ...
        this.onInitialLayoutViewLayout = this.onInitialLayoutViewLayout.bind(
            this
        );
    ...
    renderMessages() {
        const AnimatedView =
            this.props.isAnimated === true ? Animated.View : View;
        return (
            <AnimatedView
                style={{
...
GiftedChat.propTypes = {
    ...
    responseToMessage: PropTypes.func.isRequired
};
